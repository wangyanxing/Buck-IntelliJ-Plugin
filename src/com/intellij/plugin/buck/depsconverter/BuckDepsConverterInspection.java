 ...
 * @author max
 */
public class BuckDepsConverterInspection extends BaseJavaLocalInspectionTool {
  private static final Logger LOG = Logger.getInstance("#com.intellij.plugin.buck.depsconverter.BuckDepsConverterInspection");
  ...
  @NonNls
  private static final String DESCRIPTION_TEMPLATE = "testtest";
