package com.intellij.plugin.buck.notification;
...
public class EventLogger implements Runnable {
  ...
  public EventLogger(@NotNull final Project project, @NotNull final String message, final MessageType messageType) {
    this(project, message, messageType, true, null);
  }

  public EventLogger(@NotNull final Project project, @NotNull final String message, final MessageType messageType, boolean showOverChangesView,
  ...
  private static void show(final Project project, final String message, final MessageType type, final boolean showOverChangesView,
    ...
    final Runnable showErrorAction = new Runnable() {
      public void run() {
        new EventLogger(project, message, type, showOverChangesView, notificationListener).run();
      }
    };
